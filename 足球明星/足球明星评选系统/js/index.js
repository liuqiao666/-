(function() {
  ...
  dom = {
    ...
    populateCard: function($el, data) {
      ...
      + '<div class="player__img2"><img src= ' + ASSET_URL + data.asset + '></div>'
      + '<li><span>年龄</span><br/>'
      + data.dob + ' yr</li><li><span>身高</span><br/>' 
      + data.height + '</li><li><span>国籍</span><br/>' + data.origin 
      + '</li></ul>' + '<ul class="player__card__list player__card__list--last"><li><span>总比赛数</span><br/>' 
      + data.games + '</li><li><span>MVP数</span><br/>' + data.goals
      + '</li></ul>');
    },
  ...
  scenes = {
    ...
    focusPlayer: function($el) {
      ...
      $world.velocity({
        translateX: pos.world.baseX - 500,
